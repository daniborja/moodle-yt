...
if ($mform->is_cancelled()) {
	...
	redirect($CFG->wwwroot . '/local/message/manage.php', 'You cancel the message form');
	...
	redirect($CFG->wwwroot . '/local/message/manage.php', 'You created a message with title: '
